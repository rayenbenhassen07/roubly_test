...
const Statistic = () => {
  ...
  return (
    <div className='w-full Number text-center text-white py-20' id='Statistic'>
      ...
      <h2 className='space-x-5 tracking-widest text-sm lg:text-lg font-semibold text-blue-500'>{components.Statistic?.[language.valeur].Title1}</h2>
     
      <h1 className='space-x-5 tracking-widest text-lg lg:text-3xl font-extrabold'>{components.Statistic?.[language.valeur].Title2}</h1>
      ...
      <div className='pt-10 flex flex-col gap-5 mx-2 lg:text-lg '>
        <div>{components.Statistic?.[language.valeur].p4Party1}</div>
        <div>{components.Statistic?.[language.valeur].p4Party2}</div>
        <div>{components.Statistic?.[language.valeur].p4Party3}</div>
      </div>
    </div>
  )
}
